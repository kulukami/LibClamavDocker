...
cmake .. -G Ninja                                                      \
    ...
    -DRUST_COMPILER_TARGET="$TARGET_ARCH-unknown-linux-musl"           \
...
cp clamav/build/$TARGET_ARCH-unknown-linux-musl/release/libclamav_rust.a ./lib
...
cp clamav/build/clamav_rust.h ./include
